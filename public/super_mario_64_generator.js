...
bingoListOriginal[2] = [{
    ...
    name: "Get all 2 Idols in Jungle Trai",
...
bingoListOriginal[3] = [{
    ...
    name: "get all 2 idols in Crash Sight",
    types: ["aquarium"]
}, {
...
bingoListOriginal[4] = [{
    name: "Get all 2 idols in St. Claire Excacation Camp",
    types: ["BOB", "wingcap"]
}, {
...
bingoListOriginal[24] = [{
    name: "Complete the Mysterious Temple",
    types: ["DDD"]
}, {
    name: "Complete Mickay's butterflies questline",
    types: ["WDW", "vanishcap"]
}, {
    name: "Kill a mama monkey",
    types: ["THI"]
}];
bingoListOriginal[25] = [{
...
bingoListOriginal[26] = [{
    name: "Max out Canteen Upgrade",
    types: ["BBH", "vanishcap"]
}, {
    name: "Buy one of Everything from Shamn Shop",
    types: ["cannons"]
}, {
    name: "Get every Item in Harry's Backpack",
    types: ["DDD", "vanishcap"]
}, {
    name: "Clear all 5 Temples",
    types: ["RR"]
}];
export default bingoListOriginal